...
def process_all_images_in_directory(input_dir, output_dir, pkl_path): # input_dir contains .png or jpg images
...
if __name__ == '__main__':
    ...
    process_all_images_in_directory(args.input_dir, args.output_dir, args.pkl_path)
